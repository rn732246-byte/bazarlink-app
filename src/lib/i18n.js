...
const translations = {
  ...
  connectGoogle: { bn: "Google দিয়ে সংযুক্ত করুন", en: "Connect with Google", hi: "Google से जोड़ें" },
  connectGoogleDesc: {
    bn: "অন্য ফোন/ব্রাউজার থেকে খুললেও নিজের প্রোফাইল-পণ্য-অর্ডার ফিরে পেতে সংযুক্ত করুন",
    en: "Connect so you can get your profile, products and orders back on any other phone or browser",
    hi: "किसी भी अन्य फ़ोन या ब्राउज़र से भी अपनी प्रोफ़ाइल, उत्पाद और ऑर्डर वापस पाने के लिए जोड़ें",
  },
  connectedGoogle: { bn: "✅ Google দিয়ে সংযুক্ত আছে", en: "✅ Connected with Google", hi: "✅ Google से जुड़ा है" },
  connecting: { bn: "সংযুক্ত হচ্ছে...", en: "Connecting...", hi: "जोड़ा जा रहा है..." },
  connectError: {
    bn: "সংযুক্ত করতে সমস্যা হয়েছে — আবার চেষ্টা করুন",
    en: "Couldn't connect — please try again",
    hi: "कनेक्ट करने में समस्या हुई — फिर कोशिश करें",
  },
  switchedAccount: {
    bn: "এই Google অ্যাকাউন্টের আগের ডেটা খুঁজে পাওয়া গেছে — লোড হচ্ছে...",
    en: "Found earlier data for this Google account — loading...",
    hi: "इस Google खाते का पुराना डेटा मिल गया — लोड हो रहा है...",
  },
